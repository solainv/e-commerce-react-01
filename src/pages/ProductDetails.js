...
const ProductDetails = () => {
  ...
  const addToCart = () => {
    ...
    toast.success('Product added successefully')
  };
            ...
            <Row>
              ...
              <Col lg='6'>
                <div className="product__details">
                  ...
                  <motion.button whileTap={{ scale: 1.2 }} className="btn__buy" onClick={addToCart}>Add to Cart</motion.button>
                </div>
              </Col>
            </Row>
          </Container>
                      ...
                      <div className="review__wrapper ">
                        ...
                        <div className="review_form">
                          ...
                          <form action="" onSubmit={submitHandler}>
                            ...
                            <button type='submit' className="btn__buy">Send </button>
                          </form>
                        </div>
                      </div>
                    </div>
